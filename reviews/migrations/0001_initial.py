    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headline', models.CharField(max_length=128, validators=[django.core.validators.MaxLengthValidator(128)])),
                ('body', models.TextField(max_length=2048, validators=[django.core.validators.MinLengthValidator(10)])),
                ('time_created', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
